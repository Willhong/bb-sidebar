            ...
            {isWoke ? (
              ...
              <span
                className={cn(
                  ...
                  showParkActions &&
                    "[@media(hover:none)]:w-auto [@media(hover:none)]:min-w-20 [@media(hover:none)]:gap-1",
                )}
              >
                <span
                  className={cn(
                    ...
                    showParkActions &&
                      "absolute inset-y-0 right-0 group-hover/card:opacity-0 [@media(hover:none)]:static [@media(hover:none)]:opacity-100 group-has-[:focus-visible]/status-slot:opacity-0",
